<?php	
	$lang	= array
	(
		//LANGUAGE UPDATE 2012/01/26
		'grp_toplnks_send_private_post_to_all'	=> 'Send Private Post to All Members',
		//END LANGUAGE UPDATE 2012/01/26
		...
		'group_setterr_title_length'			=> 'Group Name must be from 3 to 30 characters long.',
		'group_setterr_title_chars'			=> 'Group Name can contain only letters, digits, dashes, dots and spaces.',
		'group_setterr_title_exists'			=> 'Group with this title already exists.',
		'group_setterr_name_length'			=> 'Group Alias must be from 3 to 30 characters long.',
		'group_setterr_name_chars'			=> 'Group Alias can contain only latin letters, digits, dash or underscore.',
		'group_setterr_name_exists'			=> 'Group Alias is already in use by another group.',
		'group_setterr_name_existsu'			=> 'Group Alias is already in use by a network member.',
		'group_setterr_name_existss'			=> 'Group Alias is already in use by the system.',
		...
		'group_invite_no_memebers_found' => 'No members you can invite found',
		
		'group_header_descr_activity' => '#NUM_MEMBERS# members &middot #NUM_POSTS# posts', 
		'group_settings_f_alias'		=> 'Group Alias:',
		'group_settings_avatar_remove' => 'Remove current avatar',
		'group_settings_add_admin_not_group_member' => '#USERNAME# is not a member of this group, and can\'t be added as admin',
		'group_settings_add_admin_not_network_member' => '#USERNAME#  is not a member of the network',
		'group_tabs_my_groups'		=> 'My Groups',
		'groups_pagetitle'	=> 'Groups - #SITE_TITLE#',
	);
