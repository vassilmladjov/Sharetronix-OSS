<?php
	...
	$html	.= '
									...
									<h1 class="pagetitle">Cache Settings</h1>
	...
	$html	.= '
										<form name="f" method="post" action=""><br /><br />
										<table class="form-container default">
											<tr>
												<td width="320">
													<label>
											...
											<tr>
												<td style="padding-top: 20px;"><button type="submit" name="submit" value="Continue" class="btn blue"><span>Continue</span></button></td>
											</tr>
										</table>
										</form>
									';
