	...
	$html	.= '
										...
										<table class="form-container">
											<tr>
												...
												<td><input type="text" autocomplete="off" class="setinp" name="ADMIN_USER" value="'.htmlspecialchars($s['ADMIN_USER']).'" /></td>
											</tr>
											<tr>
												<td class="field-title">Admin Password:</td>
												<td><input type="password" autocomplete="off" class="setinp" name="ADMIN_PASS" value="'.htmlspecialchars($s['ADMIN_PASS']).'" /></td>
											</tr>
											<tr>
												<td class="field-title">Password Again:</td>
												<td><input type="password" autocomplete="off" class="setinp" name="ADMIN_PASS2" value="'.htmlspecialchars($s['ADMIN_PASS2']).'" /></td>
											</tr>
											<tr>
												<td class="field-title">E-Mail Address:</td>
												<td><input type="text" class="setinp" name="ADMIN_EMAIL" value="'.htmlspecialchars($s['ADMIN_EMAIL']).'" /></td>
											</tr>
											<tr>
